...
const emailRegistro = async (datos) => {
    ...
    const info = await transporter.sendMail({
        ...
        <head>
          ...
          <title>Confirmación de Registro - TOPMEDIA+</title>
          <!--[if mso]>
          <style>
              ...
              <tr>
                <td align="center" style="padding: 0;">
                  ...
                  <table role="presentation" style="padding: 0px 0px 40px 0px; width: 94%; max-width: 600px; border: none; border-spacing: 0; text-align: left; font-family: Arial, sans-serif; font-size: 16px; line-height: 22px; color: #363636; margin: 0 auto;">
                    <tr>
                      <td style="padding: 40px 0px 40px 0px; text-align: center; font-size: 24px; font-weight: bold;">
                        <span lang="es" style="font-size: 36.0pt;">TOPMEDIA+</span>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding: 10px; background-color: #ffffff;">
                        <p style="font-size: 18px; text-align: center; font-weight: bold;">Confirmación de Registro</p>
                        <p>Hola <b>${USER_NAME}</b>,</p>
                        <p>Gracias por registrarte en TopMedia+. Tu cuenta está lista. Solo necesitas confirmarla haciendo clic en el siguiente enlace:</p>
                        <p style="text-align: center;"><b><a href="${process.env.FRONTEND}/confirm/${tokenunico}" style="color: #0000EE; text-decoration: underline;">Confirmar cuenta</a></b></p>
                        <p>Si no has solicitado una cuenta, por favor, ignora este mensaje.</p>
                      </td>
                    </tr>
                    <tr>
