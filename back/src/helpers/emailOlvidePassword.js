                          ...
                          <tr>
                            <td align="center" style="padding:0;">
                              ...
                              <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                                ...
                                <p align="center" style="text-align: center"><span lang="es-419" style="font-size: 18.0pt; padding-top: 15px; font-family: &quot;Verdana&quot;,sans-serif">Restablecimiento de contraseña.</span></p>
                                <tr>
                                  <td style="padding:30px; background-color:#ffffff;">
                                  <br/>
                                  <br/>
                                  <p>Hola: <b>${USER_NAME}</b>, has solicitado restablecer tu contraseña en TopMedia+.</p>
                                  <br/>
                                  <br/>
