...
export default function CardFileAddMovieAdult() {
  ...
  const renderRandomBoxes = () => {
    ...
    for (let i = 0; i < boxCount; i++) {
      ...
      boxes.push(
        <div className="bg-white rounded-md shadow p-4 mb-4" key={key}>
          <div className="w-full sm:w-auto h-32 bg-gray-200 rounded-md mb-4">
            <Skeleton height={32} width="100%" direction="ltr" />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className={` w-full sm:w-auto w-${width} h-${height} bg-gray-200 rounded-md`}>
              <Skeleton height={height} width="100%" direction="ltr" />
            </div>
            <div className={`w-full sm:w-auto w-${width} h-${height} bg-gray-200 rounded-md`}>
              <Skeleton height={20} width="100%" direction="ltr" />
            </div>
            <div className={`w-full sm:w-auto w-${width} h-${height} bg-gray-200 rounded-md`}>
              <Skeleton height={height} width="100%" direction="ltr" />
            </div>
            ...
            <div className={ `w-full sm:w-auto w-${width} h-${height} bg-gray-200 rounded-md`}>
              <Skeleton height={15} width="100%" direction="ltr" />
            </div>
            <div className={`w-full sm:w-auto w-${width} h-${height} bg-gray-200 rounded-md`}>
              <Skeleton height={10} width="100%" direction="ltr" />
            </div>
