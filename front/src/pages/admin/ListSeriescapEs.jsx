...
const AddCapSerieAdult = () => {
  ...
  `;
                            ...
                            <button className="animate__animated animate__bounceIn bg-red-500 hover:bg-red-700 font-bold  p-2 text-white" onClick={(e) => {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        clienteAxios.delete(`/mttvshowschapter/${tableMeta.rowData[0]}/${import.meta.env.VITE_ID_MOVIES_ES}`, config).then(() => {
                                            // actualizar el state
                                            consultarApi()
    ...
    return (
        <>
            <main>
                <div className="relative bg-red-500 p-4 sm:p-6 rounded-sm overflow-hidden mb-8">
