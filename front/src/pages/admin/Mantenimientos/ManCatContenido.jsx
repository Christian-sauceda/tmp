...
import Banner from '../../../partials/dashboard/BannerCatContenido.jsx';

//components
import Formulario from '../../../components/Forms/FormularioContenido';
import ListadoContenidos from '../../../components/List/ListadoContenidos';

const ManCatContenido = () => {
...
export default ManCatContenido