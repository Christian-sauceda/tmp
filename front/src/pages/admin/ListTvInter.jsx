...
import BannerListTvInter from '../../partials/dashboard/BannerListTvInter.jsx';
                    ...
                    return (
                        <>
                            <button className="bg-green-600 font-bold mr-1 p-2 text-white" onClick={() => {
                                window.location.href = `/admin/tv/inter/edit/${tableMeta.rowData[0]}`
                            }}>
                                <i className="fas fa-edit">EDITAR</i>
                            </button>

                            <button className="bg-yellow-400 font-bold  p-2 text-white" onClick={() => {
                                window.location.href = `/admin/movie/tv/inter/disabled/${tableMeta.rowData[0]}`
                            }}>
