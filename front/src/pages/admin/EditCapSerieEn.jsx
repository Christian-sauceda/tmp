...
export default function AddCapSerieEs() {
    ...
    const [editCapSerieEn, setEditCapSerieEn] = useState([]);
    const { COD } = useParams();
    ...
    const llenarDatos = () => {
        (editCapSerieEn.length > 0) ?
            (
                setBACK(editCapSerieEn[0].BACK),
                setPOSTER(editCapSerieEn[0].POSTER),
                setURL(editCapSerieEn[0].URL_VIDEO),
                setCOD_CONTENT(editCapSerieEn[0].COD_CONTENT),
                setCOD_FORMAT_VIDEO(editCapSerieEn[0].COD_CAT_FORMAT_VIDEO),
                setNAME_CHAPTER(editCapSerieEn[0].NAME_CHAPTERS),
                setNUMBER_SEASON(editCapSerieEn[0].SEASON_NUMBER),
                setNUMBER_CHAPTER(editCapSerieEn[0].CHAPTER_NUMBER),
                setSYNOSIS(editCapSerieEn[0].SYNOPSIS)) :
            null
    }
    useEffect(() => {
        llenarDatos();
